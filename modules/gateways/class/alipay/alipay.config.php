        ...
        if ($type->value != "即时到账" and $type->value != "当面付"){
			...
			if ($type->value == "即时到账") {
				$extra_config = [
                    ...
                    "rsa_key" => ["FriendlyName" => "RSA2(SHA256) 私钥", "Type" => "textarea",  'Rows' => '10', 'Cols' => '60',"Description" => '您可能需要 :<br/><a type="button" class="btn btn-primary" href="https://os.alipayobjects.com/download/secret_key_tools_RSA256_win.zip" target="_blank"><span class="glyphicon glyphicon-new-window"></span> RSA2(SHA256) 生成器下载</a> <a type="button" class="btn btn-primary" href="https://doc.open.alipay.com/docs/doc.htm?articleId=106130&docType=1" target="_blank"> <span class="glyphicon glyphicon-new-window"></span> OpenSSL生成教程</a><br/>  生成器私钥文件名 : rsa_private_key.pem 公钥文件名 : rsa_public_key.pem<br/>将私钥文件内容<br/>使用<span style="color:red">非Windows记事本打开</span> , 并将里面内容复制到上面文本框中<br/>公钥则请到'." <a href='https://openhome.alipay.com/platform/keyManage.htm' target='_blank'><span class='glyphicon glyphicon-new-window'></span> 商家支付宝 开放平台</a> 绑定", ],
                    "notice" => [
						'FriendlyName' => '',
						'Type' => 'dropdown',
						'Options' => [
